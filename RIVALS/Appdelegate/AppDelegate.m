...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    {
        [self prepareMyChallengeController];
    }
    [self showLoaderView];
...
#pragma mark - callMyChallengeView
-(void)prepareMyChallengeController{
    UIStoryboard *sb = [UIStoryboard storyboardWithName:@"MyChallenge" bundle:nil];
    UINavigationController *vc = [sb instantiateInitialViewController];
    
    self.window.rootViewController = vc;
}
#pragma mark- callsigninview
-(void) callSignInView{
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.test.identifier.RIVALS" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"RIVALS" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"RIVALS.sqlite"];
    NSError *error = nil;
